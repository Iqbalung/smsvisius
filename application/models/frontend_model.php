...
class frontend_model extends CI_Model
{
	...
	*/
	...
	function generate_coments_tutorial($slug)
	{
		$query = $this->db->query("SELECT * FROM `comments` as a inner join tutorial as b on a.id_tutorial = b.idtutorial inner join login as c on a.id_login = c.idlogin where b.slug = '$slug'");
		if($query->num_rows() > 0)
		{
		return $query;
		}
