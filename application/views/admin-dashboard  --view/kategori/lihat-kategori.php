                        ...
                        <table class="table table-hover">
                            ...
                            <?php foreach ($kategori as  $value) { ?>
                                <tr>
                                    ...
                                    <th> 
                                        <a class="btn btn-primary" href="form_edit_kategori/<?php echo $value->kat_id; ?>"><i class="fa fa-edit"></i></a>
                                        <a class="btn btn-warning" href="delete_kategori/<?php echo $value->kat_id; ?>"><i class="fa fa-eraser"></i></a>
                                    </th>
                                </tr>
                            <?php } ?>   
                        </table>
