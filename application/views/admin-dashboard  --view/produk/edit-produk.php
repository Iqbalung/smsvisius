                        ...
                        <div class="panel-body">
                            <form ENCTYPE="multipart/form-data" class="form-horizontal form-bordered" role="form" action="<?php echo site_url('admin_olshop/update_barang').'/'.$barang->pro_id ; ?>" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls col-sm-6">
                                        <input type="text" value="<?php echo $barang->pro_price; ?>" name="diskon-produk" class="form-control" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls col-sm-6">
                                        <input type="text" name="review-produk" class="form-control" value="<?php echo $barang->pro_reivew; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-3">Feature Produk</label>
                                    <div class="controls col-sm-6">
                                        <input type="text" name="feature-produk" class="form-control" value="<?php echo $barang->pro_feature; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
