            ...
            <div class="page-content">
                <div class="page-subheading page-subheading-md">
                    <ol class="breadcrumb">
                        <li class="active"><a href="javascript:;">Edit Brand</a></li>
                    </ol>
                </div>
                <div class="container-fluid-md">                    
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form" action="<?php echo base_url('index.php/admin_olshop/update_brand').'/'.$brand->id_brand ; ?>" method="POST">
                                <div class="form-group">
                                    <label class="control-label" >Brand</label>
                                    <div class="controls">
                                        <input value="<?php echo $brand->nama_brand; ?>" type="text" name="brand" class="form-control">
                                    </div>
                                </div>
