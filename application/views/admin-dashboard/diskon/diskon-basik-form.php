            ...
            <div class="page-content">
                <div class="page-subheading page-subheading-md">
                    <ol class="breadcrumb">
                        <li class="active"><a href="javascript:;">Tambah Diskon Basic</a></li>
                    </ol>
                </div>
                <div class="container-fluid-md">                    
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">Tambah Diskon Basic</h4>  
                        </div>

                        <div class="panel-body">
                            <form role="form" action="<?= base_url()?>index.php/add_diskon_basic" method="POST">
                                <div class="form-group">
                                    <label class="control-label" for="exampleInputText1">Diskon Basic</label>

                                    <div class="controls">
                                        <input type="text" name="disk-basic" class="form-control" required>
                                    </div>
                                </div>
