            ...
            <div class="page-content">
                <div class="page-subheading page-subheading-md">
                    <ol class="breadcrumb">
                        <li class="active"><a href="javascript:;">Edit Diskon Total</a></li>
                    </ol>
                </div>
                <div class="container-fluid-md">                    
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">Edit Diskon Total</h4>  
                        </div>

                        <div class="panel-body">
                            <form role="form" action="<?= base_url()?>index.php/edit_diskon_total" method="POST">
                                <div class="form-group">
                                    <label class="control-label" for="exampleInputText1">Diskon Total</label>
                                    <input type="hidden" name="id" value="<?php echo $disk->id_disk_total; ?>">
                                    <div class="controls">
                                        <input type="text" name="disk-total" value="<?php echo $disk->diskon_total; ?>" class="form-control" required>
                                    </div>
                                </div>
