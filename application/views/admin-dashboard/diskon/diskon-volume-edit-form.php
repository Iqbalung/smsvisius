                ...
                <div class="container-fluid-md">                    
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form" action="<?= base_url()?>index.php/admin_olshop/edit_diskon_volume/<?php echo $disk->id_disk_volume; ?>" method="POST">
                                <div class="form-group">
                                    <label class="control-label" >Tanggal Mulai</label>

                                    <div class="controls">
                                        <input value="<?php echo $disk->start_date; ?>" type="date" name="start" class="form-control" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input value="<?php echo $disk->end_date; ?>" type="date" name="end" class="form-control" required>
                                    </div>
                                </div>
