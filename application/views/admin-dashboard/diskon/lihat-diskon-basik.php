            ...
            <div class="page-content">
                <div class="page-subheading page-subheading-md">
                    <ol class="breadcrumb">
                        <li class="active"><a href="javascript:;">Diskon Basic</a></li>
                    </ol>
                </div>
                <div class="container-fluid-md">
                    ...
                    <!-- END NOTIFICATION -->
                     ...
                     <?php if($diskon_b == null) {?>
                        <div class="alert alert-info">
                            <button data-dismiss="alert" class="close" type="button">×</button>
                            <b>Belum ada diskon basic</b> <a href="diskon_basik_form" class="alert-link">Klik sini untuk tambah</a></span> 
                        </div>
                    <?php } else { ?>
                        <div class="panel panel-default">
                            ...
                            <table class="table table-hover">
                                ...
                                <?php  
                                    $i = 1;
                                    foreach($diskon_b as $val){ 
                                ?>

                                    <tr>
                                        <td><b><?php echo $i;?></b></td>
                                        <td><?php echo $val->diskon_basic;?></td>
                                        <td>
                                            <a class="btn btn-primary" href="form_edit_d_basic/<?php echo $val->id_disk_basic; ?>"><i class="fa fa-edit"></i></a>
                                            <a class="btn btn-warning" href="delete_d_basic/<?php echo $val->id_disk_basic; ?>"><i class="fa fa-eraser"></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </table>
