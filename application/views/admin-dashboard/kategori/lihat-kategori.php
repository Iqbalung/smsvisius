            ...
            <div class="page-content">
                <div class="page-subheading page-subheading-md">
                    <ol class="breadcrumb">
                        <li class="active"><a href="javascript:;">Kategori</a></li>
                    </ol>
                </div>
                <div class="container-fluid-md">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <a class="btn btn-primary" href="form_kategori">
                        ...
                        <table class="table table-hover">
                            ...
                            <?php foreach ($kategori as  $value) { ?>
                                <tr>
                                    <th><?php echo $value->kat_id; ?></th>
                                    <th><?php echo $value->kat_judul; ?></th>
                                    <th> 
                                        <a class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="update" href="form_edit_kategori/<?php echo $value->kat_id; ?>"><i class="fa fa-edit"></i></a>
                                        <a class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="delete" href="delete_kategori/<?php echo $value->kat_id; ?>"><i class="fa fa-eraser"></i></a>
                                    </th>
                                </tr>
                            <?php } ?>   
                        </table>
