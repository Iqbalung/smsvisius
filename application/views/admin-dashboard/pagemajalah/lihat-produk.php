                ...
                <div class="container-fluid-md">
                    ...
                    <div class="panel panel-default">
                        ...
                        <table class="table table-hover">
                            ...
                            <?php 
                                $i = 1;
                                foreach ($page_majalah as  $value) { 
                            ?>
                                <tr>
                                    <!-- <th><?php echo $value->pro_id; ?></th> -->
                                    <th><?php echo $i; ?> </th>
                                    <th><img src="<?php echo $value->picture_small?>"  width="42"> <?php echo $value->page; ?></th>
                                    <th> 
                                       
                                        <a class="btn btn-danger"  data-toggle="tooltip" data-placement="top" title="delete" href="<?= base_url() ?>index.php/admin_olshop/delete_page_majalah/<?php echo $value->id_page; ?>/<?= $value->id_majalah ?>"><i class="fa fa-eraser"></i></a>
                                    </th>
                                </tr>
                            <?php 
                                $i++;
