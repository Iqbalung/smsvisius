                ...
                <div class="container-fluid-md">                    
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">Tambah Page</h4>  
                        </div>

                       <div class="panel-body">
                            <form ENCTYPE="multipart/form-data" class="form-horizontal form-bordered" role="form" action="<?php echo base_url(); ?>index.php/admin_olshop/add_page_majalah" method="POST">
                                <div class="form-group">
                                   
                                    <div class="controls col-sm-6">
                                        <input type="hidden" name="edisi" value="<?= $majalah->id_majalah ?>" class="form-control" required>
                                    </div>
                                </div>
                                <div class="form-group">
