                ...
                <div class="container-fluid-md">                    
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form ENCTYPE="multipart/form-data" class="form-horizontal form-bordered" role="form" action="<?php echo base_url(); ?>index.php/admin_olshop/add_barang" method="POST">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="controls col-sm-6">
                                        <input type="text" name="berat-produk" class="form-control" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls col-sm-6">
                                        <input name="sub-kategori" type="hidden" value="1" class="form-control">
                                ...
                                <div class="form-group">
                                    <!-- <label class="control-label col-sm-3">Diskon Produk</label>
                                     --><div class="controls col-sm-6">
                                        <input type="hidden" value="" name="diskon-produk" class="form-control" placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls col-sm-6">
                                        <input type="hidden" value="1" name="review-produk" class="form-control" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-3">Feature Produk</label>
                                    <div class="controls col-sm-6">
                                    <label class="checkbox-inline">Yes<input type="radio" value="1" name="feature-produk" class="form-control" placeholder=""></label> <br>
                                    <label class="checkbox-inline">No<input type="radio" value="0" name="feature-produk" class="form-control" placeholder=""></label>
                                    </div>
                                </div>
                                <div class="form-group">
