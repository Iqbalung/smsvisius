...
<div class="sidebar-widget wow fadeInUp outer-bottom-vs">
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="<?= base_url()?>assets/images/products/s1.jpg" data-lightbox="image-1" data-title="Nunc ullamcors">
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="<?= base_url()?>assets/images/products/s2.jpg" data-lightbox="image-1" data-title="Nunc ullamcors">
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="<?= base_url()?>assets/images/products/s3.jpg" data-lightbox="image-1" data-title="Nunc ullamcors">
