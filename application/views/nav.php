...
<nav id="main-navigation" role="navigation" class="navbar navbar-fixed-top navbar-standard"><a href="<?php echo base_url(); ?>/otavio/javascript:void(0)" class="search_button"><i class="fa fa-search"></i></a>
        <form action="search/result" method="POST" role="search" class="h_search_form">
          <div class="container">
        ...
        <div class="container">
          ...
          <div class="navbar-collapse collapse">
            ...
            <li><a><?php if ($this->session->userdata('username')): ?>
              <?php echo (''.'Welcome '.$this->session->userdata('username').''); ?><?php endif;?></a></li>
              <li><a id="dropdownMenuLogin" href="<?php echo base_url(); ?>/otavio/#" data-toggle="dropdown" class="upper dropdown-toggle"><?php if ($this->session->userdata('username')==''){ echo 'Login'; }; ?></a>
              ...
              <li><a id="dropdownMenuCart" href="<?php echo base_url(); ?>index.php/shop/cart" data-toggle="dropdown" class="dropdown-toggle"><i class="fa fa-shopping-cart fa-lg"></i>&nbsp;<span class="badge"><?= $this->cart->total_items(); ?></span></a>
            ...
            <ul id="one-page-menu" role="menu" class="nav navbar-nav navbar-left">
              ...
              <li><a href="<?php echo base_url(); ?>/about" title="About us" data-ref="about">About us</a>
              </li>
              
              <li><a href="<?php echo base_url(); ?>/shop" title="Shop" data-ref="shop">Shop</a>
              ...
              <li><a href="<?php echo base_url(); ?>/contact" title="Contacts" data-ref="contacts">Contacts</a>
              </li>
            </ul>
          </div>
        </div>
