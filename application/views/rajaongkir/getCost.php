...
<?php echo $data['rajaongkir']['origin_details']['city_name'];?> ke <label name="destinantion" ><?php echo $data['rajaongkir']['destination_details']['city_name'];?><input type="hidden" name="destination" value"<?php echo $data['rajaongkir']['destination_details']['city_name'];?>" /> </label> <label name="berat">Berat Keseluruhan<?php echo $berat;?>gram </label> Kurir : <label name="kurir"><?php echo strtoupper($courier); ?></label>
		 ...
		 <table class="table table-striped">
			...
			?>
				<tr>
					...
					<td align="right">
				<input type="hidden" name="service" value="<?php echo $data['rajaongkir']['results'][$k]['costs'][$l]['service'];?>">
				<input type="hidden" name="shiping" value="<?php echo $data['rajaongkir']['results'][$k]['costs'][$l]['cost'][0]['value'];?>"
