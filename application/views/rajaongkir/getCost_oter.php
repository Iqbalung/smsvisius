...
?>
	 <div title="<?php echo strtoupper($data['rajaongkir']['results'][$k]['name']);?>" style="padding:10px">
		 <table class="table table-striped">
			 ...
			 ?>
			 <tr>
					 <td><input type="radio" name="shipping" value="<?php echo $data['rajaongkir']['results'][$k]['costs'][$l]['cost'][0]['value'];?>:<?php echo $data['rajaongkir']['results'][$k]['costs'][$l]['service'];?>:<?php echo $data['rajaongkir']['origin_details']['city_name'];?>:<?php echo strtoupper($courier); ?>" ></td>
				 <td><?php echo $l+1;?></td>
				 <td>
