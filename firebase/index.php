        ...
        <div class="container">
            ...
            <form class="pure-form pure-form-stacked" method="get">
                <fieldset>
                    ...
                    <label for="title1">Link</label>
                    <input type="text" id="title1" name="link" class="pure-input-1-2" placeholder="Enter title">
                    <label for="message1">Message</label>
                    <textarea class="pure-input-1-2" name="message" id="message1" rows="5" placeholder="Notification message!"></textarea>
                    <label for="title1">Image</label>
                    <input type="text" id="title1" name="image" class="pure-input-1-2" placeholder="Enter title">
